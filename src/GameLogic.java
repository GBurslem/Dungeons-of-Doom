...
public class GameLogic implements IGameLogic{
	...
	/**
	 * Constructor for GameLogic, initializes Player Position array and collected gold.
	 */
	public GameLogic(){
	...
	/**
	 * Reads the map file and initializes the Player position within the map.
	 */
	...
	public void quitGame() {
		System.out.println("The game has been won! Disconnecting Players...");
		active = false;
		System.exit(0);
	}
